...
for i, F in enumerate(F_vals):
    ...
    energies_CI, eigenvectors_CI, wavefunc_e, wavefunc_h, Psi_exciton_2D = configInteraction(x, Ve_init, Vh_init, m_e, m_h, N, pas, V_coul, lvl_e=2, lvl_h=2, lvl_exciton=0)

    energies_E0_CI.append(energies_CI[0])
    energies_E1_CI.append(energies_CI[1])
    energies_E2_CI.append(energies_CI[2])
...
plt.plot(F_vals, energies_E0_CI, label="Fondamental (e0-h0)", color='blue', marker='.')
plt.plot(F_vals, energies_E1_CI, label="1er Excité (e0-h1)", color='red', marker='.')
plt.plot(F_vals, energies_E2_CI, label="2nd Excité (e1-h0)", color='green', marker='.')
